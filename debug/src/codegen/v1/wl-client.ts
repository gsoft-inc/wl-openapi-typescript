...
export type GetGoodVibesPointResult = {
    /** @format `int32` */
    point: number;
};
export type GetGoodVibesPointError = {
    type: string;
    title: string;
    /** @format `int32` */
    status: number;
...
export function GetGoodVibesPoint(client: WorkleapClient, init: GetGoodVibesPointInit): Promise<WorkleapClientResponse<GetGoodVibesPointResult, GetGoodVibesPointError>> {
